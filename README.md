...
[Download and open apk file](https://drive.google.com/file/d/1WM-0--e5payuGTS3tgHc5Fl4CuefL9pi/view?usp=sharing) using a Tablet device
...
1. After opening the project, select **View > Tool Windows > Device Manager** from the main menu bar, and then click **Create device.**
